      ...
      <div className="px-6 py-8 sm:px-8">
        ...
        {items.length === 0 ? (
          ...
          <>
                  ...
                  <div className="flex flex-1 flex-col justify-between">
                    <div className="sm:grid sm:grid-cols-2 sm:gap-4">
                      <div className="pr-8 sm:pr-5">
                        ...
                        <p className="mt-1 text-sm text-gray-500">36EU - 4US</p>
                      </div>
            ...
            {/* Checkout button */}
            <div className="mt-8">
              <button className="group w-full bg-black text-white py-4 px-6 rounded-xl text-lg font-semibold transition-all duration-300 hover:shadow-lg flex items-center justify-center">
